...
import com.inspedio.helper.primitive.InsAnim;
 ...
 * @version 1.0
 */
public class InsAnimatedObject extends InsObject{
	...
	public InsAnimatedObject()
	{
		super();
		this.initAnimation();
	}
	
	public InsAnimatedObject(int X, int Y)
	{
		super(X, Y, 0, 0);
		this.initAnimation();
	}
	
	public InsAnimatedObject(int X, int Y, int Width, int Height)
	{
